...
Esta função se encarrega de dizer qual é o périodo atual baseado na hora
...
Estas são as daus principais funções responsáveis por deixar a aplicação mais bonita!
...
Apesar de todos os problemas que ainda possui, o detox vem ganhando força, e com tempo todos os inpecilíos podem ser resolvido seguindo forúns.
