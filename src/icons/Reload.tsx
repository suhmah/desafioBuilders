...
const ReloadIcon: React.FC = () => {
  const color = forecastConditionsIcons(
    'Chuvisco',
  ...
  return (
    <Svg
      ...
      <Path
        fill={color}
        d="M0.005,248.087C0.005,111.063,111.073,0,248.079,0c137.014,0,248.082,111.062,248.082,248.087
   c0,137.002-111.068,248.079-248.082,248.079C111.073,496.166,0.005,385.089,0.005,248.087z"
      />
      <Path
        fill={Color.white}
        d="M400.813,169.581c-2.502-4.865-14.695-16.012-35.262-5.891
